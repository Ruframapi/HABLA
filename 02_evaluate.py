...
if __name__ == "__main__":
    ...
    eer_cm, eer_threshold = eval_asvspoof.compute_eer(bonafide, spoofed)
    print("Score file: {:s}".format(data_path))
    #print("mintDCF: {:1.4f}".format(mintDCF))
    print("EER: {:2.3f}%".format(eer_cm * 100))
    print("Threshold: {:f}".format(eer_threshold))
